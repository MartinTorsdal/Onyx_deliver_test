...
namespace checkVatServiceRef
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="checkVatServiceRef.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<checkVatServiceRef.checkVatResponse> checkVatAsync(checkVatServiceRef.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<checkVatServiceRef.checkVatApproxResponse> checkVatApproxAsync(checkVatServiceRef.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    checkVatServiceRef.matchCode traderNameMatch, 
                    checkVatServiceRef.matchCode traderCompanyTypeMatch, 
                    checkVatServiceRef.matchCode traderStreetMatch, 
                    checkVatServiceRef.matchCode traderPostcodeMatch, 
                    checkVatServiceRef.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface checkVatPortTypeChannel : checkVatServiceRef.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<checkVatServiceRef.checkVatPortType>, checkVatServiceRef.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<checkVatServiceRef.checkVatResponse> checkVatAsync(checkVatServiceRef.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<checkVatServiceRef.checkVatApproxResponse> checkVatApproxAsync(checkVatServiceRef.checkVatApproxRequest request)
        {
